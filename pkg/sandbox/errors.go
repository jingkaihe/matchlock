...
var (
	...
	ErrCreateDNSProxy          = errors.New("create DNS proxy")
	ErrCreateUpstreamDialer    = errors.New("create upstream dialer")
	ErrCreateTailscaleDialer   = errors.New("create tailscale dialer")
	ErrMissingTailscaleAuthKey = errors.New("missing tailscale auth key")
	ErrDNSProxyClose           = errors.New("DNS proxy close")
	ErrUpstreamDialerClose     = errors.New("upstream dialer close")
